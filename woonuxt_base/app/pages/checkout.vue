...
definePageMeta({
  pageTransition: {
    name: 'page',
    mode: 'default', // 'out-in' causes the error
  },
});
  ...
  <div class="flex flex-col min-h-[600px]">
    <template v-if="cart && customer">
      ...
      <form v-else class="container flex flex-wrap items-start gap-8 my-16 justify-evenly lg:gap-20" @submit.prevent="payNow">
        <div class="grid w-full max-w-2xl gap-8 checkout-form md:flex-1 border p-4 rounded-md">
          <!-- Customer details -->
          <div v-if="!viewer && customer.billing">
            <h2 class="w-full mb-2 text-3xl font-semibold leading-none">Contact Information</h2>
