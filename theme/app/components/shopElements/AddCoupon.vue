  ...
  <div>
    <form class="flex gap-1" @submit.prevent="submitCoupon">
      <input
        ...
        class="w-full px-4 py-2 border rounded-md shadow-sm outline-none"
        required
      />
      <button
        class="flex items-center justify-center px-4 py-2 border rounded-md outline-none min-w-20 hover:bg-black hover:text-white"
